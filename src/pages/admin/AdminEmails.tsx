...
const templates: TemplateDefinition[] = [
  {
    ...
    bodyTitle: "Vielen Dank fuer Ihre Bewerbung",
    bodyLines: (c) => [
      "Sehr geehrte/r Max Mustermann,",
      `wir haben Ihre Bewerbung als Vollzeit-Mitarbeiter bei ${c} erhalten und werden diese sorgfaeltig pruefen.`,
  ...
  },
  {
    ...
    bodyLines: (c) => [
      "Sehr geehrte/r Max Mustermann,",
      `wir freuen uns, Ihnen mitteilen zu koennen, dass Ihre Bewerbung bei ${c} angenommen wurde.`,
      "Im naechsten Schritt bitten wir Sie, einen Termin fuer Ihr Bewerbungsgespraech zu vereinbaren.",
    ],
    buttonText: "Gespraechstermin buchen",
  ...
  },
  {
    ...
    subject: (c) => `Ihre Bewerbung bei ${c}`,
    bodyTitle: "Rueckmeldung zu Ihrer Bewerbung",
    bodyLines: (c) => [
      "Sehr geehrte/r Max Mustermann,",
      `vielen Dank fuer Ihr Interesse an einer Taetigkeit bei ${c}.`,
      "Nach sorgfaeltiger Pruefung muessen wir Ihnen leider mitteilen, dass wir uns fuer einen anderen Kandidaten entschieden haben.",
      "Wir wuenschen Ihnen fuer Ihren weiteren Werdegang alles Gute.",
      "Mit freundlichen Gruessen",
    ],
  },
  {
    eventType: "gespraech_erfolgreich",
    label: "Gespraech erfolgreich",
    subject: (c) => `Naechster Schritt: Arbeitsvertrag – ${c}`,
    bodyTitle: "Ihr Bewerbungsgespraech war erfolgreich",
    bodyLines: (c) => [
      "Sehr geehrte/r Max Mustermann,",
      `wir freuen uns, Ihnen mitteilen zu koennen, dass Ihr Bewerbungsgespraech bei ${c} erfolgreich verlaufen ist.`,
      "Bitte fuellen Sie im naechsten Schritt Ihren Arbeitsvertrag aus.",
    ],
    buttonText: "Arbeitsvertrag ausfuellen",
  ...
  },
  {
    ...
    bodyLines: (c) => [
      "Sehr geehrte/r Max Mustermann,",
      `Ihr Arbeitsvertrag bei ${c} wurde genehmigt. Sie koennen sich ab sofort mit folgenden Zugangsdaten einloggen:`,
      "E-Mail: max.mustermann@example.com",
      "Passwort: Temp1234!",
      "Bitte aendern Sie Ihr Passwort nach dem ersten Login. Ihr Arbeitsvertrag muss noch unterzeichnet werden.",
    ],
  ...
  },
  {
    ...
    bodyTitle: "Ihr Auftragstermin wurde bestaetigt",
    bodyLines: () => [
      "Sehr geehrte/r Max Mustermann,",
      "Ihr Termin fuer den Auftrag #12345 wurde erfolgreich gebucht:",
      "Datum: 15.03.2026",
      "Uhrzeit: 14:00 Uhr",
      "Bitte fuehren Sie den Auftrag zum vereinbarten Zeitpunkt durch.",
    ],
  },
  {
    ...
    bodyLines: () => [
      "Sehr geehrte/r Max Mustermann,",
      "Ihre Bewertung fuer den Auftrag #12345 wurde geprueft und genehmigt.",
      "Die entsprechende Praemie wurde Ihrem Konto gutgeschrieben.",
  ...
  },
  {
    ...
    bodyLines: () => [
      "Sehr geehrte/r Max Mustermann,",
      "Ihre Bewertung fuer den Auftrag #12345 wurde geprueft und leider abgelehnt.",
      "Bitte fuehren Sie die Bewertung erneut durch. Achten Sie dabei auf die Vorgaben des Auftrags.",
    ],
